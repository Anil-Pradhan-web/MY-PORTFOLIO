  ...
  <div class="mb-3">
    ...
    <div class="space-y-3">
      ...
      <div>
        ...
        <ul class="list-disc list-outside ml-4 text-[9px] text-slate-600 space-y-0.5 leading-relaxed">
          ...
          <li>Developed a full-stack React dashboard and AI chat to inject P1 bugs in real time, view task breakdowns, and auto-rerun the pipeline.</li>
        </ul>
        <div class="mt-1.5 ml-4 text-[8.2px] text-slate-500 font-semibold">
