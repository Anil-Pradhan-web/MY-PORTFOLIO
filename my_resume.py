  ...
  <div class="mb-3 font-sans">
    ...
    <div>
      <div class="flex justify-between items-baseline mb-0.5">
        <h4 class="text-[9.8px] font-bold text-slate-900">College Ambassador (Internship) <span class="text-slate-400 font-normal">|</span> <span class="text-[#1e3a8a]">Techfest, IIT Bombay</span></h4>
      ...
      <ul class="list-disc list-outside ml-4 text-[9.2px] text-slate-600 space-y-0.5 leading-relaxed">
        <li>Completed verified tasks across web development, event management, and creatives — including landing page builds, event ideation, and social media content for Asia's largest tech festival.</li>
        <li>Executed marketing, outreach, and media tasks — including sponsorship communication, SEO research, and digital ecosystem mapping — as part of a performance-based ambassador program.</li>
      </ul>
    </div>
  </div>
    ...
    <div class="grid grid-cols-2 gap-x-8 gap-y-1.5 text-[9.2px] leading-snug">
      ...
      <div class="space-y-1.5">
        ...
        <div class="flex items-start">
          ...
          <span class="text-slate-600 font-semibold">FastAPI, REST APIs, WebSockets, LangGraph, SQLAlchemy, Pydantic, JWT, OAuth 2.0</span>
        </div>
        <div class="flex items-start">
      ...
      <div class="space-y-1.5">
        <div class="flex items-start">
          ...
          <span class="text-slate-600 font-semibold">Docker, GitHub Actions, Render, Vercel, Git, Postman</span>
        </div>
        <div class="flex items-start">
        ...
        <div class="flex items-start">
          ...
          <span class="text-slate-600 font-semibold">RAG, Agentic AI, Multi-Agent Systems, LLM Integration, Semantic Search</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div>
    ...
    <div class="grid grid-cols-2 gap-x-8 gap-y-1.5 text-[9.1px] text-slate-600 leading-relaxed">
      <div class="flex items-start gap-1.5">
        ...
        <span><strong class="text-slate-900">2nd Runner-Up — Dell FutureMinds AI Hackathon 2026:</strong> Advanced through a 4-stage national selection (8,000+ participants → 370 → Top 10 → Top 6 Grand Finalists) to secure 3rd position; presented final solution to Dell jury, senior leaders, and employees at Dell Bengaluru office.</span>
      </div>
      <div class="flex items-start gap-1.5">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
      ...
      <div class="flex items-start gap-1.5 col-span-2 mt-0.5">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
        <span><strong class="text-slate-900">Certifications:</strong> Wells Fargo Software Engineering Job Simulation (Forage), Cisco Python Essentials 2, HackerRank Java / Python / SQL / Problem Solving (Basic), IBM AI Fundamentals.</span>
      </div>
    </div>
  </div>
</body>
