...
<body class="bg-white p-0 text-slate-800">
  ...
  <div class="bg-[#0f172a] text-white rounded-lg p-5 flex justify-between items-center mb-4.5">
    ...
    <div class="w-[40%] flex flex-col items-end text-[9.5px] text-slate-200 space-y-1.5">
      ...
      <div class="flex items-center gap-1.5 justify-end mt-2 pt-1 border-t border-slate-700 w-full font-mono text-[9px] text-sky-400">
        ...
        <span class="text-slate-500">|</span>
        <a href="https://my-portfolio-anil.vercel.app/" class="hover:underline font-semibold">Portfolio</a>
      </div>
    </div>
  </div>
  ...
  <div class="mb-4.5">
    ...
    <div class="space-y-4">
      ...
      <div>
        <div class="flex justify-between items-baseline mb-0.5">
          <h4 class="text-[10px] font-bold text-slate-900 flex items-center gap-1">
            <span class="text-[#1e3a8a]">AI Career Mentor</span> 
            <span class="text-slate-400 font-normal">|</span> 
            <a href="https://ai-career-mentor-anil.vercel.app/" class="text-[#1e3a8a] hover:underline font-semibold text-[9.5px]">Live Demo</a> 
            <span class="text-slate-400 font-normal">|</span> 
            <a href="https://github.com/Anil-Pradhan-web/ai-career-mentor" class="text-[#1e3a8a] hover:underline font-semibold text-[9.5px]">GitHub</a>
          </h4>
          <span class="text-[9px] text-slate-500 font-mono">Mar 2026 – Present</span>
        </div>
        <div class="text-[9.2px] text-slate-500 italic font-medium ml-0.5 mb-1">Solo Full Stack Developer</div>
        <ul class="list-disc list-outside ml-4 text-[9.4px] text-slate-600 space-y-0.5 leading-relaxed">
          <li>Architected a parallel LangGraph workflow with 7 specialized AI agents, reducing end-to-end career analysis latency by 60% (4 min → 60 sec).</li>
          <li>Built a real-time AI Mock Interview Engine using FastAPI, WebSockets, and a 7-stage Finite State Machine (FSM), delivering company-specific technical interviews with live coding evaluation and personalized feedback.</li>
          <li>Developed "Anya", a real-time multimodal AI Voice Coach powered by the Gemini Live API, enabling full-duplex voice conversations with resume-aware career guidance, interview coaching, and personalized learning support.</li>
          <li>Engineered a fault-tolerant multi-LLM architecture (Groq, NVIDIA NIM, Cerebras) with circuit breakers, automatic failover, and rate limiting, achieving uninterrupted service availability.</li>
          <li>Optimized RAG retrieval using local ONNX embeddings with keyword-search fallback, eliminating embedding API dependency while ensuring reliable performance on low-memory cloud deployments validated through 116 automated tests.</li>
        </ul>
        <div class="mt-1.5 ml-4 text-[8.5px] text-slate-500 font-semibold">
      ...
      <div>
        <div class="flex justify-between items-baseline mb-0.5">
          <h4 class="text-[10px] font-bold text-slate-900 flex items-center gap-1">
            <span class="text-[#1e3a8a]">TaskPilot AI</span> 
            <span class="text-slate-400 font-normal">|</span> 
            <a href="https://taskpilot-ai-app.onrender.com/" class="text-[#1e3a8a] hover:underline font-semibold text-[9.5px]">Live Demo</a> 
            <span class="text-slate-400 font-normal">|</span> 
            <a href="https://github.com/IdeaForg-e/TaskPilot-AI" class="text-[#1e3a8a] hover:underline font-semibold text-[9.5px]">GitHub</a>
          </h4>
          <span class="text-[9px] text-slate-500 font-mono">Jun 2026 – Jul 2026</span>
        </div>
        <div class="text-[9.2px] text-slate-500 italic font-medium ml-0.5 mb-1">Integration Lead | Team IdeaForg-E</div>
        <ul class="list-disc list-outside ml-4 text-[9.4px] text-slate-600 space-y-0.5 leading-relaxed">
          <li>Architected a multi-agent engineering productivity platform integrating 7 fragmented developer tools (Jira, GitHub, Slack, Email, Calendar, Meetings, and Incidents), reducing manual task tracking by ~2 hours/day.</li>
          <li>Designed a hybrid AI task extraction pipeline combining heuristic rules, fuzzy matching, and LLM reasoning (Qwen), recovering 35% more hidden action items while reducing LLM inference costs by 75% through selective AI execution.</li>
          <li>Built a concurrency-safe orchestration backend using FastAPI, SQLite WAL mode, and Redis, enabling reliable parallel multi-agent execution with real-time P1 incident reprioritization in under 15 seconds.</li>
  ...
  <div>
    ...
    <div class="grid grid-cols-2 gap-x-8 gap-y-1.5 text-[9.4px] text-slate-600 leading-relaxed">
      ...
      <div class="flex items-start gap-2">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
        <span>Competitions: Participated in multiple IIT/NIT coding contests and hackathons focused on AI systems, backend engineering, and algorithmic problem solving.</span>
      </div>
      <div class="flex items-start gap-2">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
      ...
      <div class="flex items-start gap-2">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
        <span>Hackathons: Built production-grade MVP solutions for Microsoft AI DevDays ($80K+), Amazon Nova AI ($95K+), and Google Solution Challenge 2026.</span>
      </div>
      <div class="flex items-start gap-2">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
      ...
      <div class="flex items-start gap-2">
        <span class="text-sky-500 font-bold flex-shrink-0">&bull;</span>
        <span>Active participant in Developer Communities (GDG Events) and college tech events, exploring AI systems, cloud infrastructure, and backend engineering.</span>
      </div>
    </div>
  </div>
</body>
