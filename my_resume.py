...
<body class="bg-white p-0 text-slate-800">
  ...
  <!-- Header Section -->
  <div class="bg-[#0f172a] text-white rounded-lg p-4.5 flex justify-between items-center mb-4.5">
    <!-- Left: Profile Info -->
    <div class="w-[58%]">
  ...
  <!-- Education Section -->
  <div class="mb-4.5">
    <div class="flex items-center gap-2.5 border-b border-slate-200 pb-1.5 mb-3">
      <!-- Circle Icon Badge -->
  ...
  <div class="mb-4.5 font-sans">
    ...
    <div>
      ...
      <ul class="list-disc list-outside ml-4 text-[9.1px] text-slate-600 space-y-0.5 leading-relaxed">
  ...
  <div class="mb-4.5">
    ...
    <div class="grid grid-cols-2 gap-x-8 gap-y-1.5 text-[9.1px] leading-snug">
      <!-- Column 1 -->
  ...
  <div>
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-3">
      <div class="w-5.5 h-5.5 bg-[#1e3a8a] text-white rounded-full flex items-center justify-center flex-shrink-0">
        <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 gap-x-8 gap-y-2 text-[9.1px] text-slate-600 leading-relaxed">
