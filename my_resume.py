...
<body class="bg-white p-4 max-w-[8.5in] mx-auto text-slate-800">

  <!-- Header Section -->
  <div class="bg-[#0f172a] text-white rounded-xl p-5 flex justify-between items-center mb-5">
    <!-- Left: Profile Info -->
    <div class="w-[58%]">
      <h1 class="text-3xl font-extrabold tracking-tight">ANIL PRADHAN</h1>
      <h2 class="text-xs font-bold tracking-wider text-sky-400 mt-1 uppercase">Backend Engineer | AI Systems Builder</h2>
      <p class="text-[10px] text-slate-300 mt-3 leading-relaxed">
    ...
    <div class="w-[40%] flex flex-col items-end text-[10px] text-slate-200 space-y-1.5 font-mono">
  ...
  <div class="mb-5">
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-2.5">
      ...
      <h3 class="text-[12px] font-extrabold tracking-wider text-[#0f172a] uppercase flex-grow">Education</h3>
    ...
    <div class="grid grid-cols-2 gap-6 text-[10.5px]">
      <div>
        ...
        <p class="text-slate-500 font-mono text-[9.5px] mt-0.5">2024 – 2028 &nbsp;|&nbsp; <span class="font-bold text-slate-900">CGPA: 9.11/10</span></p>
      </div>
      <div class="border-l border-dashed border-slate-300 pl-4">
        ...
        <p class="text-slate-500 font-mono text-[9.5px] mt-0.5">2022 – 2024 &nbsp;|&nbsp; <span class="font-bold text-slate-900">Percentage: 85%</span></p>
      </div>
    </div>
  </div>
  ...
  <div class="mb-5">
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-2.5">
      ...
      <h3 class="text-[12px] font-extrabold tracking-wider text-[#0f172a] uppercase flex-grow">Experience</h3>
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div>
      <div class="flex justify-between items-baseline mb-1">
        <h4 class="text-[10.5px] font-bold text-slate-900">College Ambassador <span class="text-slate-400 font-normal">|</span> <span class="text-[#1e3a8a]">Techfest, IIT Bombay</span></h4>
        <span class="text-[9.5px] text-slate-500 font-mono">Jun 2026 – Present</span>
      </div>
      <ul class="list-disc list-outside ml-4 text-[9.8px] text-slate-600 space-y-0.5">
  ...
  <div class="mb-5">
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-2.5">
      ...
      <h3 class="text-[12px] font-extrabold tracking-wider text-[#0f172a] uppercase flex-grow">Technical Projects</h3>
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="space-y-3.5">
      ...
      <div>
        <div class="flex justify-between items-baseline mb-0.5">
          <h4 class="text-[10.5px] font-bold text-slate-900">
          ...
          <span class="text-[9.5px] text-slate-500 font-mono">March 2026 – Present</span>
        </div>
        <ul class="list-disc list-outside ml-4 text-[9.8px] text-slate-600 space-y-0.5">
      ...
      <div>
        <div class="flex justify-between items-baseline mb-0.5">
          ...
          <span class="text-[9.5px] text-slate-500 font-mono">June 2026 – July 2026</span>
        </div>
        <ul class="list-disc list-outside ml-4 text-[9.8px] text-slate-600 space-y-0.5">
  ...
  <div class="mb-5">
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-2.5">
      ...
      <h3 class="text-[12px] font-extrabold tracking-wider text-[#0f172a] uppercase flex-grow">Technical Skills</h3>
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
      </svg>
    </div>

    <div class="grid grid-cols-6 gap-2 text-[9.5px]">
      <div class="border-r border-slate-100 pr-1.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">Languages</h4>
      ...
      <div class="border-r border-slate-100 pr-1.5 pl-0.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">Backend</h4>
        <ul class="space-y-0.5 text-slate-600 font-medium">
          <li>FastAPI</li>
          <li>LangGraph</li>
          <li>Pydantic</li>
      ...
      <div class="border-r border-slate-100 pr-1.5 pl-0.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">Frontend</h4>
        <ul class="space-y-0.5 text-slate-600 font-medium">
          <li>HTML</li>
          <li>CSS</li>
          <li>Tailwind CSS</li>
      ...
      <div class="border-r border-slate-100 pr-1.5 pl-0.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">Database</h4>
        <ul class="space-y-0.5 text-slate-600 font-medium">
          <li>Neon Postgres</li>
          <li>SQLite</li>
          <li>Upstash Redis</li>
      ...
      <div class="border-r border-slate-100 pr-1.5 pl-0.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">DevOps/Tools</h4>
        <ul class="space-y-0.5 text-slate-600 font-medium">
          <li>Docker</li>
      ...
      <div class="pl-0.5">
        <h4 class="font-bold text-[#1e3a8a] mb-1">AI / LLM / RAG</h4>
        <ul class="space-y-0.5 text-slate-600 font-medium">
          <li>Groq Cloud</li>
  ...
  <div class="mb-2">
    <div class="flex items-center gap-3 border-b border-slate-200 pb-1.5 mb-2.5">
      ...
      <h3 class="text-[12px] font-extrabold tracking-wider text-[#0f172a] uppercase flex-grow">Achievements & Certifications</h3>
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 gap-x-6 gap-y-1.5 text-[9.6px] text-slate-600 leading-normal">
