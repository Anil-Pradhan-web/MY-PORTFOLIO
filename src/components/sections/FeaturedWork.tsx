...
const projects = [
  {
    ...
    features: [
      ...
      'Used AI-assisted development (Claude, codex and Antigravity) to design high-level architecture — DAG structure, FSM design, and failover strategy — for solo delivery of a production-grade platform.',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Used AI-assisted development (Claude,Codex and Antigravity) to design the orchestration flow and failover architecture, while handling integration and deployment myself.',
    ],
