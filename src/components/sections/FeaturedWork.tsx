...
const projects = [
  ...
  },
  {
    ...
    features: [
      'Built an 8-agent AI system that collects tasks from 5 platforms and deduplicates them automatically using fuzzy matching + LLM-verified fusion.',
      'Designed a 7-factor ranking engine to prioritize urgent issues, score task quality, and generate dynamic, meeting-aware daily schedules.',
      ...
      'Developed a full-stack React dashboard and AI chat copilot to inject P1 bugs in real time, view task breakdowns, and trigger pipeline re-runs.',
    ],
