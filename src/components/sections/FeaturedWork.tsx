...
const projects = [
  ...
  },
  {
    ...
    features: [
      'Built an 8-agent AI system that collects tasks from 7 platforms (Jira, GitHub, Slack, Email) and removes duplicates automatically.',
      'Designed an 8-factor ranking engine to prioritize urgent issues, score task quality, and create dynamic, meeting-aware daily schedules.',
      ...
      'Developed a full-stack React dashboard and AI chat to inject P1 bugs in real time, view task breakdowns, and auto-rerun the pipeline.',
    ],
