...
const projects = [
  {
    ...
    tagline: 'AI/ML & Pipeline Engineer · Team: Disha & Anil · Aug 2026 – Present',
    description:
      'Engineered an industrial-grade, zero-trust hardware forensic platform to detect counterfeit electronics, altered serials, and tampered components through an 8-stage LangGraph state machine combining localized YOLO11n computer vision, multi-agent swarms, and Groq LPU causal arbitration.',
    challenge:
      'Hardware counterfeit fraud costs global supply chains $100B+ annually. Manual QA takes 4+ hours per PCB, frequently missing laser-etched serial swaps (e.g. A00-00 vs A00-0O), desoldered 0402 SMD passives, and non-OEM warranty seals under factory lighting.',
    solution:
      'Built an autonomous 8-stage inspection engine integrating 30ms defensive fast-fail gates, fine-tuned YOLO11n (98.4% mAP), localized 8x–12x ROI zoom scheduling, deterministic Anomaly Max-Pooling, and Groq LPU causal arbitration in under 4 seconds.',
    architecture: {
      layers: [
        { name: 'Quality Gate', tech: 'OpenCV Laplacian Blur Variance (>100) & Exposure Bounds (<25ms)', stage: '01', icon: Shield, color: '#009688' },
        { name: 'Authenticity Gate', tech: 'Error Level Analysis (ELA) Clone-Stamp & Forgery Screening', stage: '02', icon: Eye, color: '#10B981' },
        { name: 'Blueprint Match', tech: '3072-dim Gemini & CLIP Embeddings + FAISS Retrieval (<15ms)', stage: '03', icon: Globe, color: '#34D399' },
        { name: 'ROI Priority Scheduler', tech: 'Priority Queue Micro-ROI Segmentation (8x–12x Zoom Engine)', stage: '04', icon: Workflow, color: '#38BDF8' },
        { name: 'Forensic Agent Swarm', tech: 'Concurrent 4 Agents: PaddleOCR · Label NCC · YOLO11n · Gemini VLM', stage: '05', icon: Bot, color: '#818CF8' },
        { name: 'Evidence Fusion', tech: 'Weighted Anomaly Max-Pooling (Zero-Dilution Defect Scoring)', stage: '06', icon: Zap, color: '#F59E0B' },
        { name: 'AI Forensic Judge', tech: 'Groq LPU (gpt-oss-20b) Causal Root-Cause Arbitration (~420ms)', stage: '07', icon: BrainCircuit, color: '#EC4899' },
        { name: 'Policy & Audit Engine', tech: 'Industrial Governance & Cryptographically Signed PDF Report', stage: '08', icon: Terminal, color: '#A855F7' },
      ],
    },
    metrics: [
      { label: 'Detection Accuracy', value: '98.4%', detail: 'mAP@50 on 4,448 custom images' },
      { label: 'End-to-End Latency', value: '< 4.0s', detail: 'Sub-second edge inference + Groq' },
      { label: 'Defensive Fast-Fail', value: '< 30ms', detail: 'Laplacian blur & ELA screening' },
      { label: 'Automated Tests', value: '203', detail: 'Hermetic Pytest suite passing' },
    ],
    features: [
      '8-Stage LangGraph State Machine & Fast-Fail Gates — Built a deterministic StateGraph with sub-30ms Laplacian blur and Error Level Analysis (ELA) gates, eliminating wasted neural compute on blurry or manipulated uploads.',
      'Fine-Tuned YOLO11n Component Detector (98.4% mAP@50) — Curated and annotated 4,448 hardware images across 8 component classes, training a custom Ultralytics YOLO11n model to accurately detect and locate components as small as 12×12 px.',
      'Stage 4 Localized ROI Zoom & Scale Normalization — Formulated an 8x–12x localized sub-region crop scheduler with Hungarian bipartite spatial matching, eliminating scale drift across microscopic 0402 SMD passives.',
      'Mathematical Evidence Fusion (Anomaly Max-Pooling) — Designed an anomaly detection approach using OCR and FAISS to improve detection of critical hardware defects, with zero dilution of small missing passives.',
      'Real-Time SSE Telemetry Stream — Implemented real-time inspection updates using Server-Sent Events (SSE), allowing operators to track 8-stage pipeline progress and receive inspection results instantly.',
      'Hermetic 203-Test QA Suite & Cryptographic Certification — Authored 23 test modules with 100% offline mocking, powering an automated ReportLab certificate generator with SHA-256 tamper-proof provenance.',
    ],
    stack: ['Python', 'FastAPI', 'LangGraph', 'YOLO11n', 'OpenCV', 'FAISS', 'Groq LPU', 'Gemini 3.5 Flash'],
    githubUrl: 'https://github.com/Disha-1610/VisionForge',
    liveUrl: '',
  },
  {
    id: 'taskpilot-ai',
    ...
    features: [
      'Agent 0 Orchestrator & Self-Healing Pipeline — Built the orchestrator for a 6-stage AI pipeline, coordinating task collection, extraction, deduplication, quality checks, prioritization, and scheduling across 5 data sources.',
      'Lifecycle & State Management (14–18s) — Implemented the pipeline lifecycle and state management to handle stage execution and recovery, completing the full workflow in around 14–18 seconds.',
      ...
      "Reliable LLM Integration & Instant P1 Copilot — Built a reliable LLM client with fallback mechanisms to survive API failures, plus real-time P1 task injection through the AI copilot to instantly move urgent incidents to the #1 priority.",
    ],
