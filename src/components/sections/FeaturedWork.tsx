...
const projects = [
  {
    ...
    features: [
      ...
      'Used AI-assisted development (Claude Code, Codex, and Antigravity) to design high-level architecture — DAG structure, FSM design, and failover strategy — for solo delivery of a production-grade platform.',
    ],
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Sources', value: '8', detail: 'integrated' },
      { label: 'Priority Factors', value: '8', detail: 'factor system' },
      { label: 'P1 Detection', value: 'Auto', detail: 're-run pipeline' },
    ],
    features: [
      'Built the orchestrator service coordinating an 8-agent pipeline (Ingestion → Extraction → Fusion → Quality → Priority → Planning) with self-healing stale-run recovery.',
      'Integrated autonomous re-prioritization — a chat agent that injects new incidents and auto-triggers the full pipeline re-run in real time.',
      'Implemented multi-provider LLM failover (Groq → NVIDIA NIM → local heuristics) ensuring the pipeline never breaks even without API keys.',
      'Led end-to-end integration and deployment (Render + CI/CD) connecting 8 data sources into a unified SQLite-backed pipeline.',
      'Used AI-assisted development (Claude Code, Codex, and Antigravity) to design the orchestration flow and failover architecture, while handling integration and deployment myself.',
    ],
