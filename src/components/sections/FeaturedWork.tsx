...
const projects = [
  {
    ...
    architecture: {
      layers: [
        { name: 'Defensive Screening', tech: 'Laplacian Blur & ELA Forensic Gates (<30ms)', stage: '01', icon: Shield, color: '#009688' },
        { name: 'Vector Intelligence', tech: 'Open_CLIP ViT-B/32 + FAISS Similarity Index', stage: '02', icon: Globe, color: '#34D399' },
        { name: 'ROI Scheduler', tech: 'Localized 8x–12x Micro-Scale Crop Engine', stage: '03', icon: Eye, color: '#38BDF8' },
        { name: 'Forensic Agent Swarm', tech: 'Custom YOLO11n (98.4% mAP) · PaddleOCR · Surface VLM', stage: '04', icon: Bot, color: '#818CF8' },
        { name: 'Mathematical Fusion', tech: 'Deterministic Anomaly Max-Pooling (Anti-Dilution)', stage: '05', icon: Workflow, color: '#F59E0B' },
        { name: 'Causal Judge & Audit', tech: 'Groq LPU (gpt-oss-20b, ~420ms) · Signed PDF Report', stage: '06', icon: BrainCircuit, color: '#EC4899' },
      ],
    },
    metrics: [
    ...
    features: [
      ...
      'Fine-Tuned YOLO11n Component Detector (98.4% mAP@50) — Curated and annotated 4,448 multi-spectral hardware images across 8 component classes, training a custom Ultralytics YOLO11n PyTorch model for sub-millimeter localization.',
      ...
      'Mathematical Evidence Fusion (Anomaly Max-Pooling) — Designed a zero-dilution mathematical aggregation engine: ensures a single missing capacitor or altered IC triggers a quarantine verdict without being averaged out.',
      'Groq LPU Causal Arbitration & Dual-Provider VLM Failover — Synthesized conflicting forensic clues into plain-language causal rationale in ~420ms using Groq LPU (gpt-oss-20b), backed by transparent Gemini 3.5 Flash failover.',
