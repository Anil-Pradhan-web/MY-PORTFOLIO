...
const projectsList = [
{
  ...
  features: [
    ...
    "🧠 Full Career Analysis: LangGraph parallel orchestrator executing Resume and Market nodes concurrently, fanning in to LinkedIn and Roadmap nodes, streaming real-time status via Server-Sent Events (SSE)",
