...
const projectsList = [
{
  ...
  description:
    "A production-grade, full-stack career coaching platform that orchestrates 6 specialized AI workflows (Resume Intelligence, Roadmaps, Market Explorer, LinkedIn Optimizer, WebSocket Mock Interview Engine, and Gemini Live Voice Coach). Built on a decoupled microservices architecture with a Next.js 14 SPA on Vercel, a FastAPI gateway on Render, Neon Serverless Postgres, and Upstash Redis. Features a parallel LangGraph DAG, a Hybrid Semantic RAG Engine (ChromaDB + in-memory MockRAG OOM fallback), real-time WebSocket mock interviews, full-duplex Hinglish voice coaching (Gemini Live), and a robust rate limiting / caching layer. Verified with 102 passing tests and zero circular dependencies.",
  highlight:
    "LangGraph DAG Orchestration · Gemini Live Voice Coach · ChromaDB Hybrid RAG · Groq & NVIDIA NIM Integration · 102 Pytest Tests · $975K Hackathon Prize Pools",
  stats: [
    { label: "AI Workflows", value: "6" },
    { label: "Voice Coach", value: "Gemini Live" },
    { label: "Test Coverage", value: "102 tests" },
  ...
  features: [
    ...
    "🏗️ CI/CD & Deployments: GitHub Actions pipeline running frontend lint/build and backend pytest (102 tests) + pip-audit, with auto-deploys via Vercel, Render, and GHCR",
  ],
  architecture: {
  ...
  quickStats: {
    commits: "254+",
    tests: "102 passing pytest",
    agents: "6 (Resume, Market, LinkedIn, Roadmap, Interview, Voice Coach)",
    ...
    codeQuality: "Zero circular deps · Pydantic validation · 102 tests · 100% availability",
  },
